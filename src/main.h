...
static const unsigned int FORK_TIME = 1491576703; //  Sun, 03 Apr 2016 15:00:00 GMT 
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees);int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, unsigned int nTime);  
